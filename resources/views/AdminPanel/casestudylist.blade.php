                        ...
                        <td>
                          <div class="dropdown action-div">
                            ...
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="{{route('casestudydetails',['id' => $items->id])}}"><i class="fas fa-eye"></i> View</a></li>
                              <li><a class="dropdown-item" href="{{route('updatecasestudy',['id' => $items->id])}}"><i class="fas fa-pencil-alt"></i> Edit</a></li>
                              <li><a class="dropdown-item" href="{{route('deletecasestudy',['id' => $items->id])}}"><i class="fas fa-trash-alt"></i> Delete</a></li>
                            </ul>
                          </div>
                        </td>
                      </tr>
